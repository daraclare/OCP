				...
				<div class="row">
					...
					<div class="span8">
						<ul id="main_menu">
							...
							<li class="current_menu_ancestor"><a href="contact.html"><i class="icomoon-envelop"></i>Contact</a></li>
						</ul>
			...
			<div class="container">
				<div class="row">
					<div class="span4">
						...
						<p>
							<strong class="blue">Address:</strong> 114 Rath Lodge<br>
					...
					<div class="span4">
                        ...
                        <p>For safety and reliability reasons, it is a legal imperative that all gas installers are registered with thr RGII. Please visit the <a class="blue2white" href="http://www.rgii.ie/home/eoghan-o`connor-plumbing-heating.6532.html" target="_blank"> RGII website</a> to view details for O'Connor Plumbing as a register installer.</p>
						
					</div>
					
                    <div class="span4">
						<h4>SEAI Grants Available</h4>
						<p>Did you know you can now get money back on a new boiler and new central heating installation? <a class="blue2white" href="contact.html">Contact us</a> now for more information.
						</p>
			...
			<div class="container">
				<div class="row">
					<div class="span8 copyright">
						© 2015 O'Connor Plumbing and Heating | Site by <a href="http://www.daraclare.com" target="_blank">Dara Clare</a>
					</div>
				</div>
			</div>
		</div>
